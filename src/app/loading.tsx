  ...
  return (
    <div className="flex min-h-[70vh] items-center justify-center">
      <div className="glass-panel flex w-full max-w-md flex-col items-center gap-6 rounded-[32px] p-10 text-center">
        <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-white/90 shadow-lg shadow-black/20">
          <Image src="/dalow-logo.svg" alt="dalow logo" width={30} height={30} />
        </div>
        <div>
